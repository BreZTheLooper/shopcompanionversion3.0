...
function handleCheckoutQR(raw) {
  // Clear any pending checkout data from a previous scan
  window._pendingCheckoutData = null;
...
function renderCheckoutOrder(data) {
  ...
  // Merge totals into data so completeCheckout can read them
  ...
  el.innerHTML = `
    ...
    <button class="btn btn-success btn-lg w-full" style="margin-top:20px"
      onclick="completeCheckout(window._pendingCheckoutData)">
      ✅ Confirm Payment
    </button>`;
}

/* ============================================================
   END WEIGHT VERIFICATION (removed)
   ============================================================ */
